...
define( 'CHILD_THEME_NAME', 'Airy Theme' );
define( 'CHILD_THEME_URL', 'http://japsterinc.com/themes/airy' );
...
add_theme_support( 'genesis-custom-header', array( 'width' => 408, 'height' => 279 ) );
...
genesis_register_sidebar( array(
	...
	'name'			=> __( 'Home Content Left', 'blissful' ),
	'description'	=> __( 'This is the left content section of the homepage', 'blissful' ),
) );
genesis_register_sidebar( array(
	'id'			=> 'home-content-right',
	'name'			=> __( 'Home Content Right', 'blissful' ),
	'description'	=> __( 'This is the left content section of the homepage', 'blissful' ),
) );
genesis_register_sidebar( array(
